...
public class UserJwtService {
    ...
    public ApiResult getUserDataFromJwt(String userJwt) {
        ...
        try {
            ...
            if (userJwtMap == null) {
                return ApiResult.make(false, "00201"); // 회원토큰 분석중 오류가 발생했습니다.
            }
        }
